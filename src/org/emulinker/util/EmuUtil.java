...
public class EmuUtil {
    ...
    public static byte hexToByte(char[] hex) throws NumberFormatException {
        if (hex.length != 2) {
            throw new NumberFormatException("Invalid number of digits in "
                    + new String(hex));
        }
    ...
    public static String readString(ByteBuffer buffer, int stopByte,
            Charset charset) {
    ...
    public static void writeString(ByteBuffer buffer, String s, int stopByte,
            Charset charset) {
    ...
    public static Object construct(String className, Object args[])
        ...
        try {
            ...
            throw new InstantiationException("Problem constructing new "
