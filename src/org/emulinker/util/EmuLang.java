...
public class EmuLang {
    ...
    /*
     * public static void reload() { try { Class klass =
     * RESOURCE_BUNDLE.getClass().getSuperclass(); Field field =
     * klass.getDeclaredField("cacheList"); field.setAccessible(true);
     * sun.misc.SoftCache cache = (sun.misc.SoftCache)field.get(null);
     * cache.clear(); } catch(Exception e) {
     * 
     * } }
     */
    ...
    public static String getString(String key, Object... messageArgs) {
        try {
            return (new MessageFormat(RESOURCE_BUNDLE.getString(key)))
                    .format(messageArgs);
        }
        catch (MissingResourceException e) {
            log.error("Missing language property: " + key);
