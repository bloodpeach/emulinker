...
public interface KailleraServer extends Startable {
    ...
    public KailleraUser newConnection(InetSocketAddress clientSocketAddress,
            String protocol, KailleraEventListener listener)
            throws ServerFullException, NewConnectionException;

    public void login(KailleraUser user) throws PingTimeException,
            ClientAddressException, ConnectionTypeException, UserNameException,
            LoginException;

    public void chat(KailleraUser user, String message) throws ChatException,
            FloodException;

    public KailleraGame createGame(KailleraUser user, String romName)
            throws CreateGameException, FloodException;

    public void quit(KailleraUser user, String message) throws QuitException,
