...
public interface KailleraUser {
    ...
    public static final String[] CONNECTION_TYPE_NAMES = { "DISABLED", "Lan",
            "Excellent", "Good", "Average", "Low", "Bad" };
    ...
    public static final String[] STATUS_NAMES = { "Playing", "Idle",
            "Connecting" };
    ...
    public void login() throws PingTimeException, ClientAddressException,
    ...
    public KailleraGame createGame(String romName) throws CreateGameException,
            FloodException;

    public void quit(String message) throws QuitException, DropGameException,
    ...
    public void gameChat(String message, int messageID)
    ...
    public void quitGame() throws DropGameException, QuitGameException,
            CloseGameException;
