...
public class KailleraRelay extends UDPRelay {
    ...
    public static void main(String args[]) throws Exception {
        ...
        new KailleraRelay(localPort,
                new InetSocketAddress(serverIP, serverPort));
    }

    public KailleraRelay(int listenPort, InetSocketAddress serverSocketAddress)
            throws Exception {
    ...
    protected ByteBuffer processServerToClient(ByteBuffer receiveBuffer,
        ...
        if (inMessage instanceof ConnectMessage_HELLOD00D) {
            ...
            try {
                new V086Relay(portMsg.getPort(), new InetSocketAddress(
                        getServerSocketAddress().getAddress(),
                        portMsg.getPort()));
            }
            catch (Exception e) {
