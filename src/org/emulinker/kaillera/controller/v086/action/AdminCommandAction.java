...
public class AdminCommandAction implements V086Action {
    ...
    public void performAction(V086Message message,
        ...
        if (accessManager.getAccess(clientHandler.getRemoteInetAddress()) < AccessManager.ACCESS_ADMIN) {
            if (chat.startsWith(COMMAND_SILENCE)
                    ...
                    && (accessManager.getAccess(clientHandler
                            .getRemoteInetAddress()) > AccessManager.ACCESS_ELEVATED)) {
            ...
            try {
                clientHandler
                        .send(new InformationMessage(
                                ...
                                "server", EmuLang.getString("AdminCommandAction.Failed", e.getMessage()))); //$NON-NLS-1$ //$NON-NLS-2$
            }
    ...
    private void processHelp(String message, KailleraServerImpl server,
        ...
        clientHandler.send(new InformationMessage(clientHandler
                ...
                "server", EmuLang.getString("AdminCommandAction.HelpVersion"))); //$NON-NLS-1$ //$NON-NLS-2$
        try {
            Thread.sleep(20);
        }
        catch (Exception e) {
        ...
        if (admin.getAccess() == AccessManager.ACCESS_SUPERADMIN) {
            clientHandler
                    .send(new InformationMessage(
                            clientHandler.getNextMessageNumber(),
                            "server", EmuLang.getString("AdminCommandAction.HelpTempAdmin"))); //$NON-NLS-1$ //$NON-NLS-2$
            try {
                Thread.sleep(20);
            }
            catch (Exception e) {
        ...
        clientHandler.send(new InformationMessage(clientHandler
                .getNextMessageNumber(),
                "server", EmuLang.getString("AdminCommandAction.HelpKick"))); //$NON-NLS-1$ //$NON-NLS-2$
        try {
            Thread.sleep(20);
        }
        catch (Exception e) {
        ...
        clientHandler.send(new InformationMessage(clientHandler
                .getNextMessageNumber(),
                "server", EmuLang.getString("AdminCommandAction.HelpSilence"))); //$NON-NLS-1$ //$NON-NLS-2$
        try {
            Thread.sleep(20);
        }
        catch (Exception e) {
        ...
        clientHandler.send(new InformationMessage(clientHandler
                .getNextMessageNumber(),
                "server", EmuLang.getString("AdminCommandAction.HelpBan"))); //$NON-NLS-1$ //$NON-NLS-2$
        try {
            Thread.sleep(20);
        }
        catch (Exception e) {
        ...
        clientHandler.send(new InformationMessage(clientHandler
                .getNextMessageNumber(),
                "server", EmuLang.getString("AdminCommandAction.HelpClear"))); //$NON-NLS-1$ //$NON-NLS-2$
        try {
            Thread.sleep(20);
        }
        catch (Exception e) {
        ...
        clientHandler
                .send(new InformationMessage(
                        clientHandler.getNextMessageNumber(),
                        "server", EmuLang.getString("AdminCommandAction.HelpCloseGame"))); //$NON-NLS-1$ //$NON-NLS-2$
        try {
            Thread.sleep(20);
        }
        catch (Exception e) {
        ...
        clientHandler
                .send(new InformationMessage(
                        clientHandler.getNextMessageNumber(),
                        "server", EmuLang.getString("AdminCommandAction.HelpAnnounce"))); //$NON-NLS-1$ //$NON-NLS-2$
        try {
            Thread.sleep(20);
        }
        catch (Exception e) {
        ...
        clientHandler
                .send(new InformationMessage(
                        clientHandler.getNextMessageNumber(),
                        "server", EmuLang.getString("AdminCommandAction.HelpAnnounceAll"))); //$NON-NLS-1$ //$NON-NLS-2$
        try {
            Thread.sleep(20);
        }
        catch (Exception e) {
        ...
        clientHandler
                .send(new InformationMessage(
                        clientHandler.getNextMessageNumber(),
                        "server", EmuLang.getString("AdminCommandAction.HelpAnnounceGame"))); //$NON-NLS-1$ //$NON-NLS-2$
        try {
            Thread.sleep(20);
        }
        catch (Exception e) {
        ...
        clientHandler
                .send(new InformationMessage(
                        clientHandler.getNextMessageNumber(),
                        "server", EmuLang.getString("AdminCommandAction.HelpFindUser"))); //$NON-NLS-1$ //$NON-NLS-2$
        try {
            Thread.sleep(20);
        }
        catch (Exception e) {
        ...
        clientHandler
                .send(new InformationMessage(
                        clientHandler.getNextMessageNumber(),
                        "server", EmuLang.getString("AdminCommandAction.HelpFindGame"))); //$NON-NLS-1$ //$NON-NLS-2$
        try {
            Thread.sleep(20);
        }
        catch (Exception e) {
        ...
        clientHandler.send(new InformationMessage(clientHandler
                .getNextMessageNumber(),
                "server", "/stealthon /stealthoff_ join room unnoticed")); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        if (admin.getAccess() == AccessManager.ACCESS_SUPERADMIN) {
            ...
            clientHandler.send(new InformationMessage(clientHandler
                    .getNextMessageNumber(),
                    "server", "/tempelevated <UserID> <min> gives elevation.")); //$NON-NLS-1$ //$NON-NLS-2$
        }
    }
    ...
    private void processFindUser(String message, KailleraServerImpl server,
        ...
        for (KailleraUserImpl user : server.getUsers()) {
            ...
            if (user.getName().toLowerCase().contains(str.toLowerCase())) {
                ...
                clientHandler.send(new InformationMessage(clientHandler
                        .getNextMessageNumber(), "server", sb.toString())); //$NON-NLS-1$
                foundCount++;
            }
        }
        ...
        if (foundCount == 0) {
            clientHandler
                    .send(new InformationMessage(
                            clientHandler.getNextMessageNumber(),
                            "server", EmuLang.getString("AdminCommandAction.NoUsersFound"))); //$NON-NLS-1$ //$NON-NLS-2$
        }
    }
    ...
    private void processFindGame(String message, KailleraServerImpl server,
        ...
        if (foundCount == 0) {
            clientHandler
                    .send(new InformationMessage(
                            clientHandler.getNextMessageNumber(),
                            "server", EmuLang.getString("AdminCommandAction.NoGamesFound"))); //$NON-NLS-1$ //$NON-NLS-2$
        }
    }
    ...
    private void processSilence(String message, KailleraServerImpl server,
        ...
        try {
            ...
            if ((access == AccessManager.ACCESS_MODERATOR)
                ...
                throw new ActionException(
                        "You cannot silence an elevated user if you're not an admin!"); //$NON-NLS-1$
            }
            ...
            if (admin.getAccess() == AccessManager.ACCESS_MODERATOR) {
                ...
                if (minutes > 15) {
                    throw new ActionException(
                            "Moderators can only silence up to 15 minutes!"); //$NON-NLS-1$
                }
            }
            ...
            server.announce(
                    EmuLang.getString(
                            "AdminCommandAction.Silenced", minutes, user.getName()), false, null); //$NON-NLS-1$ 
        }
        ...
        try {
            ...
            if (user == null) {
                throw new ActionException(EmuLang.getString(
                        "AdminCommandAction.UserNotFound", userID)); //$NON-NLS-1$
            }
            ...
            throw new ActionException(
                    EmuLang.getString("AdminCommandAction.KickError")); //$NON-NLS-1$
        }
    }
    ...
    private void processCloseGame(String message, KailleraServerImpl server,
        ...
        try {
            ...
            if (game == null) {
                throw new ActionException(EmuLang.getString(
                        "AdminCommandAction.GameNotFound", gameID)); //$NON-NLS-1$
            }
    ...
    private void processBan(String message, KailleraServerImpl server,
        ...
        try {
            ...
            server.announce(
                    EmuLang.getString(
                            "AdminCommandAction.Banned", minutes, user.getName()), false, null); //$NON-NLS-1$ 
            ...
            throw new ActionException(
                    EmuLang.getString("AdminCommandAction.BanError")); //$NON-NLS-1$
        }
    }
    ...
    private void processTempElevated(String message, KailleraServerImpl server,
        ...
        if (admin.getAccess() != AccessManager.ACCESS_SUPERADMIN) {
            throw new ActionException(
                    "Only SUPER ADMIN's can give Temp Elevated Status!"); //$NON-NLS-1$
        }
        ...
        try {
            ...
            server.getAccessManager().addTempElevated(
                    user.getConnectSocketAddress().getAddress()
                            .getHostAddress(), minutes);
            server.announce(
                    "Temp Elevated Granted: " + user.getName() + " for " + minutes + "min", false, null); //$NON-NLS-1$ //$NON-NLS-2$
        }
        catch (NoSuchElementException e) {
    ...
    private void processTempAdmin(String message, KailleraServerImpl server,
        ...
        if (admin.getAccess() != AccessManager.ACCESS_SUPERADMIN) {
            throw new ActionException(
                    "Only SUPER ADMIN's can give Temp Admin Status!"); //$NON-NLS-1$
        }
        ...
        try {
            ...
            server.announce(
                    EmuLang.getString(
                            "AdminCommandAction.TempAdminGranted", minutes, user.getName()), false, null); //$NON-NLS-1$ 
        }
        catch (NoSuchElementException e) {
            throw new ActionException(
    ...
    private void processStealth(String message, KailleraServerImpl server,
        ...
        if (message.equals("/stealthon")) {
            ...
            clientHandler.send(new InformationMessage(clientHandler
                    .getNextMessageNumber(), "server", "Stealth Mode is on.")); //$NON-NLS-1$ //$NON-NLS-2$
        }
        else if (message.equals("/stealthoff")) {
            admin.setStealth(false);
            clientHandler.send(new InformationMessage(clientHandler
                    .getNextMessageNumber(), "server", "Stealth Mode is off.")); //$NON-NLS-1$ //$NON-NLS-2$
        }
        else {
            throw new ActionException(
                    "Stealth Mode Error: /stealthon /stealthoff"); //$NON-NLS-1$
        }
    }

    private void processTrivia(String message, KailleraServerImpl server,
            KailleraUserImpl admin,
            V086Controller.V086ClientHandler clientHandler)
            throws ActionException, MessageFormatException {
        if (message.equals("/triviareset")) {
            ...
            server.announce("<Trivia> " + "SupraTrivia has been reset!", false,
                    null);
            ...
            server.announce("<Trivia> "
                    + "SupraTrivia will be paused after this question!", false,
                    null);
        }
            ...
            server.announce("<Trivia> " + "SupraTrivia has been resumed!",
                    false, null);
        }
            ...
            try {
                ...
                server.announce("<Trivia> "
                        + "SupraTrivia's question delay has been changed to "
    ...
    private void processVersion(String message, KailleraServerImpl server,
        ...
        try {
            ...
            clientHandler.send(new InformationMessage(clientHandler
                    .getNextMessageNumber(),
                    "server", "VERSION: " + releaseInfo.getProductName())); //$NON-NLS-1$ //$NON-NLS-2$
            sleep(20);

            Properties props = System.getProperties();
            clientHandler.send(new InformationMessage(clientHandler
                    .getNextMessageNumber(),
                    "server", "JAVAVER: " + props.getProperty("java.version"))); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
            sleep(20);
            clientHandler.send(new InformationMessage(clientHandler
                    .getNextMessageNumber(),
                    "server", "JAVAVEND: " + props.getProperty("java.vendor"))); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
            sleep(20);
            clientHandler.send(new InformationMessage(clientHandler
                    .getNextMessageNumber(),
                    "server", "OSNAME: " + props.getProperty("os.name"))); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
            sleep(20);
            clientHandler.send(new InformationMessage(clientHandler
                    .getNextMessageNumber(),
                    "server", "OSARCH: " + props.getProperty("os.arch"))); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
            sleep(20);
            clientHandler.send(new InformationMessage(clientHandler
                    .getNextMessageNumber(),
                    "server", "OSVER: " + props.getProperty("os.version"))); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
            sleep(20);

            Runtime runtime = Runtime.getRuntime();
            clientHandler.send(new InformationMessage(clientHandler
                    .getNextMessageNumber(),
                    "server", "NUMPROCS: " + runtime.availableProcessors())); //$NON-NLS-1$ //$NON-NLS-2$
            sleep(20);
            clientHandler.send(new InformationMessage(clientHandler
                    .getNextMessageNumber(),
                    "server", "FREEMEM: " + runtime.freeMemory())); //$NON-NLS-1$ //$NON-NLS-2$
            sleep(20);
            clientHandler.send(new InformationMessage(clientHandler
                    .getNextMessageNumber(),
                    "server", "MAXMEM: " + runtime.maxMemory())); //$NON-NLS-1$ //$NON-NLS-2$
            sleep(20);
            clientHandler.send(new InformationMessage(clientHandler
                    .getNextMessageNumber(),
                    "server", "TOTMEM: " + runtime.totalMemory())); //$NON-NLS-1$ //$NON-NLS-2$
            sleep(20);
            ...
            if (EmuUtil.systemIsWindows()) {
                clientHandler.send(new InformationMessage(clientHandler
                        .getNextMessageNumber(),
                        "server", "COMPNAME: " + env.get("COMPUTERNAME"))); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                sleep(20);
                clientHandler.send(new InformationMessage(clientHandler
                        .getNextMessageNumber(),
                        "server", "USER: " + env.get("USERNAME"))); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                sleep(20);
            }
            else {
                clientHandler.send(new InformationMessage(clientHandler
                        .getNextMessageNumber(),
                        "server", "COMPNAME: " + env.get("HOSTNAME"))); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                sleep(20);
                clientHandler.send(new InformationMessage(clientHandler
                        .getNextMessageNumber(),
                        "server", "USER: " + env.get("USERNAME"))); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
