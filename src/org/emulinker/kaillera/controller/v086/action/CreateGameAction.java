...
public class CreateGameAction implements V086Action, V086ServerEventHandler {
    ...
    public void performAction(V086Message message,
        ...
        if (!(message instanceof CreateGame_Request)) {
            throw new FatalActionException(
                    "Received incorrect instance of CreateGame: " + message);
        }
        ...
        try {
            ...
            try {
                clientHandler.send(new InformationMessage(clientHandler
                        ...
                        "CreateGameAction.CreateGameDenied", e.getMessage())));
    ...
    public void handleEvent(ServerEvent event,
        ...
        try {
            ...
            if (temp.toLowerCase().contains("69")
            ...
            clientHandler.send(new CreateGame_Notification(clientHandler
                    .getNextMessageNumber(), owner.getName(), m, owner
                    .getClientType(), game.getID(), (short) 0));
        }
