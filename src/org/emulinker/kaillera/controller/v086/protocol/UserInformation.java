...
public class UserInformation extends V086Message {
    ...
    public UserInformation(int messageNumber, String userName,
    ...
    public int getBodyLength() {
        ...
        // charset.encode(clientType).remaining() + 3);
    ...
    public String toString() {
        return getInfoString() + "[userName=" + userName + " clientType="
    ...
    public static UserInformation parse(int messageNumber, ByteBuffer buffer)
        ...
        return new UserInformation(messageNumber, userName, clientType,
                connectionType);
    }
}
