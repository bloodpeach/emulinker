...
public class UserJoined extends V086Message {
    ...
    public UserJoined(int messageNumber, String userName, int userID,
            long ping, byte connectionType) throws MessageFormatException {
        super(messageNumber);
    ...
    public static UserJoined parse(int messageNumber, ByteBuffer buffer)
        ...
        return new UserJoined(messageNumber, userName, userID, ping,
                connectionType);
    }
}
