...
public class GameKick extends V086Message {
    ...
    public GameKick(int messageNumber, int userID)
    ...
    public static GameKick parse(int messageNumber, ByteBuffer buffer)
        ...
        /*
         * SF MOD if (b != 0x00) throw new MessageFormatException("Invalid " +
         * DESC + " format: byte 0 = " + EmuUtil.byteToHex(b));
         */
        return new GameKick(messageNumber,
                UnsignedUtil.getUnsignedShort(buffer));
    }
}
