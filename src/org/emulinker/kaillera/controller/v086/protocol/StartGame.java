...
public abstract class StartGame extends V086Message {
    ...
    public StartGame(int messageNumber, int val1, short playerNumber,
            short numPlayers) throws MessageFormatException {
        super(messageNumber);
    ...
    public static StartGame parse(int messageNumber, ByteBuffer buffer)
        ...
        if (val1 == 0xFFFF && playerNumber == 0xFF && numPlayers == 0xFF) {
            ...
            return new StartGame_Notification(messageNumber, val1,
