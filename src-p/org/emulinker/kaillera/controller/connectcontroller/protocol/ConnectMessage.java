...
public abstract class ConnectMessage extends ByteBufferMessage {
    ...
    public static ConnectMessage parse(ByteBuffer buffer)
        ...
        try {
            ...
            throw new MessageFormatException(
                    "Invalid bytes received: failed to decode to a string!", e);
        }
        ...
        buffer.rewind();
        throw new MessageFormatException("Unrecognized connect message: "
