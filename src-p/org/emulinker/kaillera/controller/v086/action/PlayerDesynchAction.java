...
public class PlayerDesynchAction implements V086GameEventHandler {
    ...
    private static final String desc = PlayerDesynchAction.class
            .getSimpleName();
    ...
    public void handleEvent(GameEvent event,
        ...
        try {
            clientHandler
                    .send(new GameChat_Notification(
                            clientHandler.getNextMessageNumber(),
                            EmuLang.getString("PlayerDesynchAction.DesynchDetected"), desynchEvent.getMessage())); //$NON-NLS-1$
            // if (clientHandler.getUser().getStatus() ==
            // KailleraUser.STATUS_PLAYING)
        ...
        // {
        // log.error("Failed to drop game during desynch: " + e.getMessage(),
        // e);
        // }
    }
}
