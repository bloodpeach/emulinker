        ...
        if (doCommand) {
            ...
            if (((GameChat) message).getMessage().startsWith("/p2p")) {
                ...
                if (((GameChat) message).getMessage().equals("/p2pon")) {
                    ...
                    if (clientHandler.getUser().getGame().getOwner()
                        ...
                        for (KailleraUser u : clientHandler.getUser().getGame()
                                .getPlayers()) {
                            if (u.isLoggedIn()) {
                                u.getGame()
                                        .announce(
                        ...
                        for (KailleraUser u : clientHandler.getUser().getGame()
                            ...
                            if (u.isLoggedIn()) {
                                u.getGame()
                                        .announce(
                                                new StringBuilder()
                                                        .append(clientHandler
                                                                .getUser()
                                                                .getName())
                                                        .append(" will NOW receive ALL server activity during gameplay!")
                                                        .toString(), u);
                            }
                        }
                    }
                    ...
                    user.getGame().announce("Failed P2P: /p2pon or /p2poff",
                            user);
                }
                return;
            }
            ...
            if (((GameChat) message).getMessage().startsWith("/ignore")) {
                ...
                try {
                    ...
                    user.getServer().announce(
                            clientHandler.getUser().getName()
                                    + " is now ignoring <" + user.getName()
                                    + "> ID: " + user.getID(), false, null);
                    return;
                }
                catch (NoSuchElementException e) {
                    KailleraUserImpl user = (KailleraUserImpl) clientHandler
                            .getUser();
                    user.getServer().announce(
                            "Ignore User Error: /ignore <UserID>", false, user);
            ...
            if (((GameChat) message).getMessage().startsWith("/unignore")) {
                ...
                try {
                    ...
                    user.getServer().announce(
                            "Unignore User Error: /ignore <UserID>", false,
                            user);
            ...
            if (((GameChat) message).getMessage().startsWith("/me")) {
                ...
                for (KailleraUser user : clientHandler.getUser().getGame()
                        .getPlayers()) {
