...
public class GameStatus extends V086Message {
    ...
    public GameStatus(int messageNumber, int gameID, int val1, byte gameStatus,
            byte numPlayers, byte maxPlayers) throws MessageFormatException {
        super(messageNumber);
    ...
    public String toString() {
        return getInfoString()
                ...
                + " numPlayers=" + numPlayers + " maxPlayers=" + maxPlayers
                + "]";
    }
    ...
    public static GameStatus parse(int messageNumber, ByteBuffer buffer)
        ...
        return new GameStatus(messageNumber, gameID, val1, gameStatus,
