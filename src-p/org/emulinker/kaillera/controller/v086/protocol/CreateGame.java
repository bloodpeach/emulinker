...
public abstract class CreateGame extends V086Message {
    ...
    public CreateGame(int messageNumber, String userName, String romName,
            String clientType, int gameID, int val1)
    ...
    public int getBodyLength() {
        ...
        // charset.encode(romName).remaining() +
        // charset.encode(clientType).remaining() + 7);
    ...
    public static CreateGame parse(int messageNumber, ByteBuffer buffer)
        ...
        if (userName.length() == 0 && gameID == 0xFFFF && val1 == 0xFFFF) {
            ...
            return new CreateGame_Notification(messageNumber, userName,
                    romName, clientType, gameID, val1);
        }
    }
}