...
/**
 * An AccessManager is used retrieve, check, and store user access levels and
 * permissions, and game and emulator filters. This interface defines the static
 * access levels and methods that an AccessManager must implement. How the
...
public abstract interface AccessManager {
    ...
    public static final String[] ACCESS_NAMES = { "Banned", "Normal",
            "Elevated", "Moderator", "Admin", "SuperAdmin" };
    ...
    /**
     * Temporairly adds a user to the nanned list using a pattern algorythm
     * defined by the AccessManager implementation. While active,
     * <code>isAddressAllowed</code> should return false, and
     * <code>getAccess</code> should return <code>ACCESS_BANNED</code>.
     * 
     * @param pattern
     *            A pattern to match to an address
     * @param minutes
     *            Number of minutes this ban is valid from the time of addition
     */
    public void addTempBan(String pattern, int minutes);

    /**
     * Temporairly adds a user to the admin list using a pattern algorythm
     * defined by the AccessManager implementation. While active,
     * <code>getAccess</code> should return <code>ACCESS_ADMIN</code>.
     * 
     * @param pattern
     *            A pattern to match to an address
     * @param minutes
     *            Number of minutes this grant is valid from the time of
     *            addition
     */
    ...
    /**
     * Temporairly adds a user to the silenced list using a pattern algorythm
     * defined by the AccessManager implementation. While active,
     * <code>isSilenced</code> should return <code>true</code>.
     * 
     * @param pattern
     *            A pattern to match to an address
     * @param minutes
    ...
    /**
     * Remove temporary access status from a selection of addresses. NOTE:
     * UPDATE THIS DOC
     * 
     * @param pattern
     *            A pattern to match to an address
    ...
    /**
     * Remove silenced status from a selection of addresses. NOTE: UPDATE THIS
     * DOC
     * 
     * @param pattern
     *            A pattern to match to an address
     */
    public boolean clearTempSilence(InetAddress address);
}