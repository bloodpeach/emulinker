...
public interface KailleraGame {
    ...
    public static final String[] STATUS_NAMES = { "Waiting", "Playing",
            "Synchronizing" };
    ...
    public Collection<KailleraUser> getPlayers();
    ...
    /* Emulinker X Additions */

    public abstract void announce(String paramString,
            KailleraUser paramKailleraUser);
}
