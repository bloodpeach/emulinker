...
public final class CircularBlockingByteQueue {
    ...
    public String toString() {
        synchronized (lock) {
            return "CircularBlockingIntArray[size=" + size + " head=" + head
                    + " tail=" + tail + "]";
        }
    }
    ...
    public void grow() {
        ...
        log.debug("CircularBlockingByteQueue growing from " + oldCapacity
                + " to " + newCapacity);
    ...
    public byte[] toArray(byte a[]) {
        ...
        if (a.length < size) {
            a = (byte[]) java.lang.reflect.Array.newInstance(a.getClass()
